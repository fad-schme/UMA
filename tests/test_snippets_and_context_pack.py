"""Snippets, context pack, and semantic surface: builders, budgets, refiner, and semantic read paths.

Covers ContextPackBuilder deduplication and provenance, snippet budget
enforcement, snippet refiner presentation-only contract, semantic paging,
...
# ── test_context_pack_builder_snippet_budgets ──────────────────────────────────────────
